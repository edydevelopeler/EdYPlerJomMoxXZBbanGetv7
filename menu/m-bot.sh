...
data_ip="https://raw.githubusercontent.com/edydevelopeler/D4l4NWeDus/main/ip"
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "     \033[0;36mTelegram${NC}:  https://t.me/lunoxximpostor"
        echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
        exit
    fi
}
...
cd /usr/bin
wget https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/bot/bot.zip  >/dev/null 2>&1
unzip bot.zip >/dev/null 2>&1
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/bot/kyt.zip
unzip kyt.zip >/dev/null 2>&1
...
bot_install(){
  wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo &> /dev/null
  wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo &> /dev/null
  wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo &> /dev/null
  wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo &> /dev/null
}
fun_bar 'bot_install'
}
...
sleep 2
cd /usr/bin
wget https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip

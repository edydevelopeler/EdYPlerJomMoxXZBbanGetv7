...
sldns() {
wget https://raw.githubusercontent.com./edydevelopeler/EdYPlerJomMoxXZBbanGetv7main/slowdns/ && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget https://raw.githubusercontent.com./edydevelopeler/EdYPlerJomMoxXZBbanGetv7main/slowdns/ && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com./edydevelopeler/EdYPlerJomMoxXZBbanGetv7main/slowdns/ && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com./edydevelopeler/EdYPlerJomMoxXZBbanGetv7main/slowdns/ && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
...
echo -e  "$COLOR1│             ${WH}TERIMA KASIH                 $COLOR1│${NC}"
echo -e  "$COLOR1│        ${WH}SUDAH MENGGUNAKAN SCRIPT          $COLOR1│${NC}"
echo -e  "$COLOR1│               ${WH}VPNPREMID                  $COLOR1│${NC}"
echo -e  "$COLOR1╰══════════════════════════════════════════╯${NC}"
echo " "
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/edydevelopeler/EdYPlerJomMoxXZBbanGetv7/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi

...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "         \033[0;36mTelegram${NC} t.me/WuzzSTORE"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/edydevelopeler/D4l4NWeDus/main/"
...
REPO="https://github.com/edydevelopeler/D4l4NWeDus.git"
...
#edit link https://justpaste.it/edit/69034499/jujf9uzf3gjfhrpj
    ...
    git remote add origin https://github.com/edydevelopeler/D4l4NWeDus
    git push -f https://${TOKEN}@github.com/edydevelopeler/D4l4NWeDus.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
